    ...
    rollupOptions: {
      ...
      output: {
        manualChunks: {
          ...
          'feature-shopping-list-detail': ['./src/view/features/shopping-lists/ShoppingListDetail.svelte'],
          'feature-profile': ['./src/view/features/profile/Profile.svelte'],
          'feature-users': ['./src/view/features/users/Users.svelte'],
          'feature-admin': ['./src/view/features/admin/Admin.svelte'],
          'feature-auth-login': ['./src/view/features/auth/Login.svelte'],
          'feature-auth-register': ['./src/view/features/auth/Register.svelte'],
          'feature-privacy': ['./src/view/features/privacy/PrivacyPolicy.svelte'],
          'feature-legal': ['./src/view/features/legal/LegalNotice.svelte'],
          // UI Components
          'ui-components': [
